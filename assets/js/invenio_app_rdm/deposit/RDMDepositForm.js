                ...
                {this.config.pids.map((pid) => (
                  <Fragment key={pid.scheme}>
                    <PIDField
                      ...
                      pidType={pid.scheme}
                      unmanagedHelpText={"If a DOI does not exists create one using 10.1234567/<a-string> so it can be detected as a fake by the tool and not displayed in citations"}
                      required
                    />
                  </Fragment>
                ))}
